  ...
  return (
    <footer className="bg-zinc-800 border-t border-zinc-700 px-6 py-4 flex items-center justify-between">
      <div className="flex items-center gap-3">
        <Image
          src="/img/meuFuneral.jpg"
          width={44}
          height={44}
          alt="Capa da banda ... "
        />
        <div className="flex flex-col">
          <strong className="text-normal">Meu Funeral</strong>
          <span className="text-xs text-zinc-400">Meu Funeral</span>
        </div>
      </div>
